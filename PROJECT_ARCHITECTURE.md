...
- **Chen & Zimmermann (2022):** Open Source Asset Pricing database -- 86 CZ (2022) signed predictors covering top GKX characteristics
...
- Columns: permno, yyyymm, ret, excess_ret, 86 feature columns, liq_* columns, weight_* columns
...
- Normalization: cross-sectional rank -> quantile [0, 1] -> rescale to [-1, 1] (GKX 2020 convention)
...
Input(86) -> Dense(64)+BatchNorm+ReLU+Dropout(0.5) -> Dense(32)+BatchNorm+ReLU+Dropout(0.5) -> Dense(16)+BatchNorm+ReLU+Dropout(0.5) -> Dense(1, linear)
...
│   │                                   SELECTED_FEATURES (86), TRADABLE_FEATURES (8),
