...
from src.analysis.common.two_by_two_block import (  # noqa: F401  re-exported
...
# `set_two_by_two_widths` and `write_two_by_two_block` now live in
# src/analysis/common/two_by_two_block.py and are re-exported above so the
# formal long-short tables (22/22b) and the capacity tables (44/45) share one
# renderer (the `*=LW p<0.05` star convention is single-sourced there).
